# nvim-treesitter-queries-pug

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-pug/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-pug/actions/workflows/validate.yml)

Neovim tree-sitter queries for **pug**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-pug",
...
- [ ] Changes are scoped to `pug` — do not include files for other languages
